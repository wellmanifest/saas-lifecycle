# Ticket 004: Adopt shared Lifecycle DSL profile
...
SaaS tenant contract. Publish the exact local state graph in
`standard/saas-lifecycle.lifecycle`, validate it with the shared standalone validator,
...
- [x] AC-03: Domain conformance proves exact state and transition equality
  between the profile and the owning SaaS tenant contract.
